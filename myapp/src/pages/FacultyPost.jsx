    ...
    <div className="min-h-screen bg-[#000000] text-gray-100">
      ...
      <div className="border-b border-gray-500/50 px-4 py-6 sm:px-6 lg:px-8">
        <div className="max-w-7xl mx-auto">
          ...
          <p className="text-gray-400 text-sm sm:text-base">
            Share important announcements, events, or placement opportunities with the community
          </p>
        </div>
      </div>
      ...
      <div className="max-w-4xl mx-auto px-4 py-6 sm:px-6 lg:px-8">
        ...
        <div className="mt-6 bg-gradient-to-br from-[#232526] via-[#1a1b1c] to-[#000000] rounded-2xl border border-gray-500/30 p-6">
          <h3 className="text-lg font-semibold text-gray-100 mb-3">Posting Guidelines</h3>
          <div className="space-y-2 text-sm text-gray-400">
            <div className="flex items-start gap-2">
              <div className="w-1.5 h-1.5 bg-blue-500 rounded-full mt-2 flex-shrink-0"></div>
              <p>Ensure your content is relevant and appropriate for the academic community</p>
            </div>
            <div className="flex items-start gap-2">
              <div className="w-1.5 h-1.5 bg-blue-500 rounded-full mt-2 flex-shrink-0"></div>
              <p>Use clear and concise language in your title and description</p>
            </div>
            <div className="flex items-start gap-2">
              <div className="w-1.5 h-1.5 bg-blue-500 rounded-full mt-2 flex-shrink-0"></div>
            ...
            <div className="flex items-start gap-2">
              <div className="w-1.5 h-1.5 bg-blue-500 rounded-full mt-2 flex-shrink-0"></div>
              <p>Include external links when they provide additional valuable information</p>
            </div>
          </div>
        </div>
      </div>
