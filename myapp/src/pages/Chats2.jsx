...
function Chats() {
  ...
  const fetchAllUsers = async () => {
    try {
      ...
      response.data = response.data.filter((user1) => user1.clerkId !== user.id);
  ...
  const [chats, setChats] = useState([
    ...
    },
    {
      ...
      messages: [
        { id: 1, text: 'Are we meeting tomorrow?', sender: 'me', time: '9:40 AM' },
        { id: 2, text: 'Yes, see you tomorrow!', sender: 'them', time: '9:45 AM' },
      ]
    },
    {
      id: 3,
      ...
      messages: [
        ...
        { id: 2, text: 'Meeting at 3 PM', sender: 'Jane Smith', time: '11:30 AM' },
      ]
    }
  ]);
    ...
    if (selectedFile) {
      ...
      try {
        ...
        const newMessage = {
          ...
          content: selectedFile.type.startsWith('image/') ? previewUrl : selectedFile.name,
      ...
      prevChats.map(chat => 
        chat.id === selectedChat.id 
          ? {
              ...
              lastMessage: newMessage.type === 'text' ? newMessage.text : `Sent ${newMessage.type}`,
              time: format(new Date(), 'h:mm a')
            }
          : chat
      )
      ...
      case 'image':
        return (
          <div className="cursor-pointer" onClick={() => {
            ...
            <img src={message.content} alt="Shared" className="max-w-[200px] rounded-lg" />
          </div>
        );
      case 'file':
        return (
  ...
  const handleStarMessage = (messageId) => {
    ...
    if (message) {
      setStarredMessages(prev => [...prev, { ...message, chatId: selectedChat.id }]);
    }
  };
