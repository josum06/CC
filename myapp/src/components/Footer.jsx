...
import { FaPlus, FaBell, FaCalendar, FaUsers, FaBuilding } from "react-icons/fa";
  ...
  return (
    <div className="relative">
      <div className="sticky bottom-0 left-0 right-0 z-10 w-full bg-transparent shadow-md overflow-x-hidden">
        <div className="container mx-auto px-2 py-2 flex justify-center items-center gap-7 sm:gap-9 md:gap-11 lg:gap-13">
          ...
          <div className="flex flex-col items-center">
            <button onClick={handlePostClick} className="bg-blue-500 text-white rounded-full w-8 cursor-pointer h-8 sm:w-10 sm:h-10 md:w-12 md:h-12 flex items-center justify-center shadow-lg hover:bg-blue-600 transition">
      ...
      {dropdownOpen && (
        ...
        }} className="px-4 py-2 hover:bg-blue-100 cursor-pointer transition rounded-lg">Faculty Post</li>
            <li onClick={() => {
          
          {navigate("/PostProject")}
          
        }} className="px-4 py-2 hover:bg-blue-100 cursor-pointer transition rounded-lg">Post Project</li>
            <li onClick={() => {
          
          {navigate("/Post")}
          
        }} className="px-4 py-2 hover:bg-blue-100 cursor-pointer transition rounded-lg">Post</li>
          </ul>
        </div>
      )}
    </div>
